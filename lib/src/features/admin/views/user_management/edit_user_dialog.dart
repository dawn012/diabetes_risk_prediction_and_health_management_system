  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Obx(() {
          final user = controller.editingUser.value;
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        controller.clearUsernameError(); // 清除错误
                          ...
                          child: Column(
                            children: [
                              Obx(() {
                                ...
                                final hasExistingImage = user.profileImg.isNotEmpty;
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Email, phone, and other sensitive data cannot be edited here',
                                  style: TextStyle(
                                    fontSize: 12,
                                    color: TAdminColors.getOnSurfaceColor(darkMode),
                                  ),
