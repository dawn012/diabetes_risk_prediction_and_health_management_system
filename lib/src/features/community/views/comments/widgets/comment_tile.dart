...
class CommentTile extends StatelessWidget {
  const CommentTile({super.key, required this.comment, this.showReplyActions = true,});

  final CommentModel comment;
  final bool showReplyActions; // 控制是否显示回复相关部件
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CommentActions(comment: comment, showReplyAction: showReplyActions),

          const SizedBox(height: TSizes.sm),

          // Reply count and navigation
          if (showReplyActions && comment.replyCount > 0) ...[
            const SizedBox(height: TSizes.sm),
            Padding(
