...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.black.withValues(alpha: 0.5)), // opacity 0.5
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white.withValues(alpha: 0.5)), // opacity 0.5
